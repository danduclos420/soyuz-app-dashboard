    ...
    <section className="py-24 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-soyuz font-bold uppercase tracking-[0.3em] text-sm mb-4">Elite Gear</h2>
          <h3 className="text-4xl md:text-5xl font-black uppercase tracking-tighter text-white">Produits Vedettes</h3>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {featuredProducts.map((product) => (
            <motion.div 
              ...
              className="group"
            >
              <div className="relative aspect-[3/4] bg-carbon-surface mb-6 overflow-hidden border border-white/5 rounded-xl">
                {/* Product Image */}
                <img 
                  src={product.image} 
                  alt={product.name}
